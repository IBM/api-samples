#!/usr/bin/env python3
# This sample demonstrates how to use the /asset_model/saved_searches endpoint in the
# REST API.
...
def main():
    ...
    print(str(number_of_searches_retrieved) + ' saved searches were retrieved.')
