...
def main():
    ...
    SampleUtilities.pretty_print_request(client, 'asset_model/saved_searches', 'GET')
    ...
    if (number_of_searches_retrieved > 0):
        ...
        for search in response_body:
            ...
            # Using the /asset_model/saved_searches/{saved_search_id}/results endpoint with a GET request.
            search_endpoint_url = 'asset_model/saved_searches/' + saved_search_id + '/results'
            SampleUtilities.pretty_print_request(client, search_endpoint_url, 'GET')
            ...
            search_response_body = json.loads(search_response.read().decode('utf-8'))
