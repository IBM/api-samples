...
def main():
    ...
    SampleUtilities.pretty_print_request(client, 'reference_data/sets/rest_api_samples_testset', 'GET')
    ...
    SampleUtilities.pretty_print_request(client, 'reference_data/sets/rest_api_samples_testset?value=rest_api_sample_value', 'POST')
    response = client.call_api('reference_data/sets/rest_api_samples_testset?value=rest_api_sample_value', 'POST')
