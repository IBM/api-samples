...
def setup_data(client):
    ...
    SampleUtilities.data_setup(client, 'referencedata/mapOfSets/rest_api_samples_login_events?key=3.4.5.6&value=jane', 'POST')
    SampleUtilities.data_setup(client, 'referencedata/mapOfSets/rest_api_samples_login_events?key=2.12.42.7&value=kim', 'POST')
    SampleUtilities.data_setup(client, 'referencedata/mapOfSets/rest_api_samples_login_events?key=2.12.42.7&value=serge', 'POST')
    SampleUtilities.data_setup(client, 'referencedata/mapOfSets/rest_api_samples_login_events?key=2.12.42.7&value=sue', 'POST')
    SampleUtilities.data_setup(client, 'referencedata/mapOfSets/rest_api_samples_login_events?key=2.12.42.7&value=rick', 'POST')
